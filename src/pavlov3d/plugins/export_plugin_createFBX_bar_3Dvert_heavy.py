...
class Plugin(ExportPlugin):
    ...
    def controlPoints_verticalPlane(self,datapoint_object,key): # depth plane
        ...
        lControlPoint8 = [datapoint_object.time+datapoint_object.halfwidth_time, datapoint_object.height, datapoint_object.depth-datapoint_object.halfwidth_depth]
        lControlPoint9 = [datapoint_object.time-datapoint_object.halfwidth_time, datapoint_object.height, datapoint_object.depth-datapoint_object.halfwidth_depth]
        ...
        controlPoints_array = [lControlPoint0,lControlPoint1,lControlPoint2,lControlPoint3,
                               ...
                               lControlPoint8,lControlPoint9,lControlPoint10,lControlPoint11,
                               lControlPoint12]
        """        
        lControlPoint4 = [datapoint_object.time+datapoint_object.halfwidth_time, 0, datapoint_object.depth-datapoint_object.halfwidth_depth]
        lControlPoint5 = [datapoint_object.time+datapoint_object.halfwidth_time, datapoint_object.height, datapoint_object.depth-datapoint_object.halfwidth_depth]
        ...
        lControlPoint11b = [datapoint_object.time-datapoint_object.halfwidth_time, 0, datapoint_object.depth+datapoint_object.halfwidth_depth]
        lControlPoint12b = [datapoint_object.time+datapoint_object.halfwidth_time, 0, datapoint_object.depth+datapoint_object.halfwidth_depth]
        lControlPoint13b = [datapoint_object.time+datapoint_object.halfwidth_time, 0, datapoint_object.depth-datapoint_object.halfwidth_depth]
        lControlPoint14b = [datapoint_object.time-datapoint_object.halfwidth_time, 0, datapoint_object.depth-datapoint_object.halfwidth_depth]
        ...
        controlPoints_array = [lControlPoint0,lControlPoint1,lControlPoint2,lControlPoint3,
                               lControlPoint4,lControlPoint5,lControlPoint6,lControlPoint7,
                               lControlPoint8,lControlPoint9,
                               lControlPoint11b,lControlPoint12b,lControlPoint13b,
                               lControlPoint14b]
        """
